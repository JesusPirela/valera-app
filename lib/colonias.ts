...
export const COLONIAS: ColoniaSugerida[] = [
  ...
  { label: 'Nuevo Refugio',           zona: 'queretaro', ciudad: 'Querétaro', lat: 20.6380, lng: -100.3620 },
  ...
  { label: 'Villas del Refugio',      zona: 'queretaro', ciudad: 'Querétaro', lat: 20.6498, lng: -100.3360 },
