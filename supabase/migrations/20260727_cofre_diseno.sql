-- Los cofres pueden entregar un TOKEN de diseño profesional (tipo 'diseno_pro').
-- Se recrea registrar_premio_ruleta preservando toda la lógica y agregando la
-- rama de diseño (y de paso se corrigen los emojis rotos de las notificaciones).
