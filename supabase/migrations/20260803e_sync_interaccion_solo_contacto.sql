-- Rework de la misión de interacción: solo cuenta contactos por WhatsApp/llamada
-- (COUNT DISTINCT cliente_id con tipo IN ('mensaje','llamada')). Antes contaba
-- toda interacción (notas, cambios de estado...). Sync regenerado.
