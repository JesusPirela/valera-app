...
DECLARE
  ...
  v_asignacion JSONB; v_n_colores INT; v_n_avatares INT;
  v_tipo_real TEXT := p_tipo_premio; v_nombre_real TEXT := p_nombre_premio; v_colores TEXT[]; v_acc JSONB;
BEGIN
  ...
  -- Acceso prioritario: subida temporal de rol automática. Si el usuario ya está
  -- en el tope (Plus) o es staff, se convierte a 500 coins (no aplica el premio).
