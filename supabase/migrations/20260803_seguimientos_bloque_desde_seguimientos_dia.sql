-- FIX: la métrica 'seguimientos' del bloque (get_productividad_equipo) contaba
-- recordatorios completados, NO las ediciones de clientes. Editar un cliente
-- registra en seguimientos_dia (y da XP) pero NO se reflejaba en el bloque.
-- Rayo tenía 16 seguimientos_dia hoy y el bloque mostraba 0. Ahora el subquery
-- 'se' cuenta desde seguimientos_dia. Regenerado con pg_get_functiondef ya corregido.
