  ...
  return (
    <View style={[styles.container, { backgroundColor: c.bg }]}>
      <View style={styles.header}>
        {/* Volver a donde estabas. Antes se forzaba SIEMPRE el CRM porque el
            historial "mandaba al inicio", pero eso era el backBehavior por
            defecto de las pestañas (ya corregido en el layout a "history").
            volverHref queda de plan B si no hay historial. */}
        <TouchableOpacity
