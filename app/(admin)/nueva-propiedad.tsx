...
export default function NuevaPropiedad() {
  ...
  function aplicarDatosImportados(d: any) {
    ...
    if (addr && !d._soloEspecificaciones) {
    ...
    } else if (!d._soloEspecificaciones) {
      setTitulo(`${op} de ${tp}`)
      setTituloEditado(true)
    }
      ...
      <ScrollView style={[styles.container, { backgroundColor: c.bg }]} keyboardShouldPersistTaps="handled">
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 4 }}>
          <TextInput
            ...
            value={geoQuery}
            onChangeText={v => { setGeoQuery(v); setDireccion(v); setTituloEditado(false); setLat(null); setLng(null); const z = zonaDesdeTexto(v); if (z) setZona(z) }}
            maxLength={200}
          />
